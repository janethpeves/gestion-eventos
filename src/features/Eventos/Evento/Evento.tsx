		...
		<div className="p-6 max-w-7xl mx-auto">
			...
			<div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
				...
				<div className="lg:col-span-2">
					<ContentBox>
						<h2 className="text-xl font-bold dark:text-white mb-4">Detalles del Evento</h2>

						{/* Date */}
						<div className="mb-4">
							<label className="text-gray-500 dark:text-gray-400 text-sm">Fecha</label>
							<p className="text-gray-900 dark:text-white font-medium">{evento.fecha}</p>
						</div>

						{/* Time */}
						<div className="mb-4">
							<label className="text-gray-500 dark:text-gray-400 text-sm">Hora</label>
							<p className="text-gray-900 dark:text-white font-medium">{evento.hora}</p>
						</div>
						...
						{/* Status */}
						<div className="mb-4">
							<label className="text-gray-500 dark:text-gray-400 text-sm block mb-1">Estado</label>
						...
						<div>
							...
							<div className="space-y-3">
								{evento.proveedores.map((proveedor) => (
									<div
										key={proveedor.id}
										className="flex items-center gap-3 p-2 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-lg transition-colors"
									>
										<div
											className={`w-10 h-10 ${proveedor.color} ${
												proveedor.color?.includes("800") ? "text-white" : "text-gray-700"
										...
										<div className="flex-1">
											...
											<p className="text-gray-500 dark:text-gray-400 text-xs">{proveedor.tipo}</p>
										</div>
									</div>
								))}
							</div>
